...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Antes de ir embora,',
  headingEm: 'assista isso',
  preText: 'Eu sei o que é isso. Eu vivi por muitos anos. E aprendi que a dor não some quando a gente tenta ignorá-la, nem quando a gente só fala sobre ela. Some quando a gente aprende as regras do próprio inconsciente.',
  postText: 'Se essas palavras fizeram sentido para você, continue lendo. O próximo passo é mais simples do que você imagina.',
}
// ════════════════════════════════════════════════════════════════════
