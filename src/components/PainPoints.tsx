...
const COPY = {
  ...
  headingEm: 'alguma dessas histórias?',
  pains: [
    '"Fiz terapia por anos e a dor continua igual. Não sei mais o que fazer."',
    '"Tomo remédio todo dia mas o aperto no peito não passa. O sintoma fica."',
    '"Fico repetindo os mesmos erros e não consigo parar. É mais forte do que eu."',
    '"Já tentei de tudo. Parte de mim não acredita mais que tem jeito. Mas não conto isso pra ninguém."',
  ],
  transition: 'Se você se viu em alguma dessas frases, o que você vai ler agora pode mudar o caminho que você está percorrendo.',
}
// ════════════════════════════════════════════════════════════════════
