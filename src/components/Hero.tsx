...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'PARA QUEM ESTÁ NO LIMITE',
  h1: 'Fiz terapia por anos',
  h1Em: 'e a dor continua igual',
  subtitle: 'Existe uma saída. E você não precisa reviver tudo para encontrá-la.',
  ctaPrimary: 'Quero agendar minha sessão',
  ctaSecondary: 'ou saiba mais sobre o processo',
}
// ════════════════════════════════════════════════════════════════════
